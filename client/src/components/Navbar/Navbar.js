...
import MSIT_logo from '../../pictures/MSIT_logo.png'
  ...
  return (
    ...
    <AppBar className='appbar' position="static" color="inherit" 
      ...
      <div className='brandContainer'>
        ...
        <img className='image' src={MSIT_logo} alt='MSIT_logo' height="80px" width="80px" style={{margin:'5px 15px'}}></img>
          <Typography className='heading' variant='h3' align='center' width='100%' style={{whiteSpace:'nowrap'}}>MSIT EVENTS</Typography>
        </Link>
      </div>
    ...
    {!isMobileScreen && 
     <AppBar className='appbar' position="static" color="inherit" style={{display:'flex' , flexDirection:'row' ,borderRadius:'15px',margin:'10px 2px',padding:'5px 10px 5px 0px',alignItems:'center'}}>
      <div className='brandContainer'>
        <Link to='/' style={{display:'flex',alignItems:'center',textDecoration:'none',color:'black'}}>{/*so when someone click on logo or name it will redirect us to home page */}
        <img className='image' src={MSIT_logo} alt='MSIT_logo' height="50px" width="50px" style={{margin:'5px 15px'}}></img>
          <Typography className='heading' variant='h4' style={{fontSize:'28px'}} align='center' width='100%'>MSIT EVENTS</Typography>
        </Link>
      </div>
